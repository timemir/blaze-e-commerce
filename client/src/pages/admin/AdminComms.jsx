                ...
                >
                    ...
                    <div className="bg-blazePimary rounded-t-lg mt-1 h-full ">
                        ...
                        <nav className="mt-6">
                            <div>
                                <Link
                                    className="w-full   text-gray-400  flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start  border-l-4 border-transparent hover:text-blazeCTA"
                                    to="/admin"
                                >
